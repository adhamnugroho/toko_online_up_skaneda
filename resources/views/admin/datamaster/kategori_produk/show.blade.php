                        ...
                        <form method="post" action="" class="">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    <label for="nama_lengkap">Nama Kategori Produk</label>
                                    <input type="text" class="form-control" placeholder="Masukkan Nama Kategori Produk"
                                        ...
                                        value="{{ old('nama_kategori_produk') ? old('nama_kategori_produk') : $kategori_produk->nama_kategori_produk }}"
                                        required disabled />
                                </div>
                            </div>
                            ...
                            <div class="card-footer">
                                ...
                                <a href="{{ route('kategoriProduk') }}" class="btn btn-warning btn-sm">Kembali</a>
                            </div>
                        </form>
                    </div>
