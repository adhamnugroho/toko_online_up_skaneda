            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Form Ubah {{ $judul }}</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-md-9">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        {{-- Form Start --}}
                        <form method="get" action="{{ route('produkUpdate', $produk->id_produk) }}" class=""
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" placeholder="Pilih Kategori Produk"
                                        name="id_kategori_produk" id="id_kategori_produk" value="">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file" class="form-control pt-1" placeholder="Masukkan Foto Produk"
                                        name="foto_produk" id="foto_produk" />
                                </div>
