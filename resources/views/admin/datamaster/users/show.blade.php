                    ...
                    <div class="card card-primary">
                        ...
                        <form method="post" action="" class="">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control" placeholder="Masukkan Alamat Email"
                                        name="email" id="email"
                                        value="{{ old('email') ? old('email') : $users->email }}" required disabled />
                                </div>
                                {{-- <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="provinsi_id" id="provinsi_id" class="form-control"
                                        onchange="getKabupaten()" required disabled>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="kabupaten_id" id="kabupaten_id" class="form-control" required disabled>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Masukkan Kode Pos"
                                        ...
                                        value="{{ old('kode_pos') ? old('kode_pos') : $users->kode_pos }}" required
                                        disabled />
                                </div>
                                <div class="form-group">
                                    <label for="alamat_lengkap">Alamat Lengkap</label>
                                    <textarea type="text" class="form-control" placeholder="Masukkan Alamat Lengkap" name="alamat_lengkap"
                                        id="alamat_lengkap" value="" cols="30" row="3" required disabled>{{ old('alamat_lengkap') ? old('alamat_lengkap') : $users->alamat_lengkap }}</textarea>
                                </div>
                            ...
                            <div class="card-footer">
                                ...
                                <a href="{{ route('users') }}" class="btn btn-warning btn-sm">Kembali</a>
                            </div>
                        </form>
                    </div>
