...
Route::post('/addToChart', [UserDashboardController::class, 'addToCart'])->name('userAddToCart');
Route::post('/removeToChart', [UserDashboardController::class, 'removeToCart'])->name('userRemoveToCart');
Route::get('/checkout', [UserCheckoutController::class, 'main'])->name('userCheckout');
...
Route::get('/chekoutHistory', [UserCheckoutController::class, 'history'])->name('userCheckoutHistory');
    ...
    Route::group(['middleware' => ['checkLogin']],  function () {
        ...
        Route::group(['prefix' => 'datamaster'], function () {
            ...
            Route::group(['prefix' => 'users'], function () {
                ...
                Route::get('/update/{id}', [UsersController::class, 'update'])->name('usersUpdate');
            ...
            Route::group(['prefix' => 'kategori-produk'], function () {
                ...
                Route::get('/update/{id}', [KategoriProdukController::class, 'update'])->name('kategoriProdukUpdate');
            ...
            Route::group(['prefix' => 'produk'], function () {
                ...
                Route::get('/update/{id}', [ProdukController::class, 'update'])->name('produkUpdate');
            ...
            Route::group(['prefix' => 'transaksi'], function () {
                ...
                Route::get('/store', [TransaksiController::class, 'store'])->name('transaksiStore');
