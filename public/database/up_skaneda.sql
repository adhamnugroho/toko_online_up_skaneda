...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 07 Apr 2023 pada 11.39
...
INSERT INTO `kategori_produk` (`id_kategori_produk`, `nama_kategori_produk`, `slug_kategori_produk`, `created_at`, `updated_at`) VALUES
(1, 'Makanan', 'makanan', '2022-10-12 20:18:21', '2022-10-25 22:39:03'),
(7, 'Minuman', 'minuman', '2022-10-12 23:15:05', '2022-10-12 23:15:05'),
(8, 'Bakso', 'bakso', '2022-10-12 23:15:11', '2022-10-12 23:15:11');
...
CREATE TABLE `keranjang` (
  ...
  `qty` int(11) NOT NULL COMMENT 'jumlah kuantitas produk yang di beli',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `keranjang` (`id_keranjang`, `user_id`, `produk_id`, `qty`, `created_at`, `updated_at`) VALUES
(7, 2, 18, 1, '2022-10-21 19:59:42', '2022-10-21 19:59:42'),
(8, 2, 17, 1, '2023-01-18 02:16:51', '2023-01-18 02:16:51');
...
(15, '2022_10_10_023753_create_kategori_produks_table', 1),
(16, '2022_10_10_024623_create_produks_table', 1),
(17, '2022_10_10_030110_create_keranjangs_table', 1),
(18, '2022_10_10_040524_create_transaksis_table', 1),
(19, '2022_10_10_052451_create_transaksi_details_table', 1);
...
CREATE TABLE `produk` (
  ...
  `berat_produk` int(11) NOT NULL COMMENT 'dalam satuan gram',
...
(17, 1, 'Pocari Sweat', 'pocari-sweat', 8, 10, 10000, NULL, 'agnostik.png', '2022-10-14 22:22:47', '2022-10-21 18:31:36'),
(18, 1, 'Bakso Otong', 'bakso-otong', 9, 200, 30000, 'Minuman lemon lime dengan soda', 'gadgetin_2.jpeg', '2022-10-15 00:37:00', '2022-10-30 17:41:42'),
(19, 1, 'Sate', 'sate', 98, 200, 20000, 'Sate yang di bakar', 'kue.png', '2022-10-15 07:28:15', '2022-10-24 17:09:21'),
(20, 8, 'Bakso Goreng', 'bakso-goreng', 49, 200, 20000, 'Bakso dengan isian gorengan', 'orang_kampung.jpeg', '2022-10-15 07:29:04', '2022-10-15 23:00:17');
...
CREATE TABLE `transaksi` (
  ...
  `kode_transaksi` varchar(255) NOT NULL COMMENT 'dibuat saat pertama kali membuat transaksi',
  `kode_invoice` varchar(255) NOT NULL COMMENT 'dibuat saat merubah status transaksi menjadi Proses Admin',
  `tanggal_transaksi` date NOT NULL,
  `status_transaksi` enum('Pending','Tolak','Proses Admin','Pengiriman','Selesai') NOT NULL,
  `user_id` bigint(20) UNSIGNED NOT NULL,
  `provinsi_id` bigint(20) UNSIGNED NOT NULL,
  `kabupaten_id` bigint(20) UNSIGNED NOT NULL,
  `kode_pos` varchar(255) NOT NULL,
  `alamat_lengkap` text NOT NULL,
  `ekspedisi` varchar(255) NOT NULL COMMENT 'hanya jne',
...
INSERT INTO `transaksi` (`id_transaksi`, `kode_transaksi`, `kode_invoice`, `tanggal_transaksi`, `status_transaksi`, `user_id`, `provinsi_id`, `kabupaten_id`, `kode_pos`, `alamat_lengkap`, `ekspedisi`, `catatan_pembeli`, `created_at`, `updated_at`) VALUES
(7, 'TR-0007', '161020227', '2022-10-16', 'Selesai', 2, 35, 3576, '61354', 'Kota Mojokerto, Pulorejo', 'jne', NULL, '2022-10-15 22:58:47', '2022-10-16 06:27:19'),
(8, 'TR-0008', '16102022 8', '2022-10-16', 'Selesai', 2, 35, 3576, '61354', 'Kota Mojokerto, Pulorejo', 'jne', NULL, '2022-10-15 22:59:44', '2022-10-15 22:59:44'),
(9, 'TR-0009', '16102022 9', '2022-10-16', 'Selesai', 2, 35, 3576, '61354', 'Kota Mojokerto, Pulorejo', 'jne', NULL, '2022-10-15 23:00:17', '2022-10-15 23:00:17'),
(10, 'TR-00010', '16102022 10', '2022-10-16', 'Selesai', 2, 35, 3576, '61354', 'Kota Mojokerto, Pulorejo', 'jne', 'Bungkus dengan rapi ya!!!', '2022-10-15 23:00:58', '2022-10-15 23:00:58'),
(11, 'TR-00011', '17102022 11', '2022-10-17', 'Selesai', 2, 35, 3576, '61354', 'Kota Mojokerto, Pulorejo', 'jne', NULL, '2022-10-16 20:13:42', '2022-10-16 20:13:42'),
(16, 'TR-00016', '2210202216', '2022-10-22', 'Selesai', 2, 35, 3576, '61354', 'Kota Mojokerto, Pulorejo', 'jne', '-', '2022-10-21 18:31:36', '2022-10-22 04:42:57'),
(17, 'TR-00017', '2210202217', '2022-10-22', 'Pending', 2, 35, 3576, '61354', 'Kota Mojokerto, Pulorejo', 'jne', '-', '2022-10-21 18:33:39', '2022-10-21 18:33:39'),
(18, 'TR-00018', '2510202218', '2022-10-25', 'Pending', 2, 35, 3576, '61354', 'Kota Mojokerto, Pulorejo', 'jne', '-', '2022-10-24 17:09:21', '2022-10-24 17:09:21');
...
INSERT INTO `transaksi_detail` (`id_transaksi_detail`, `transaksi_id`, `produk_id`, `qty`, `created_at`, `updated_at`) VALUES
(1, 7, 17, 1, '2022-10-15 22:58:47', '2022-10-15 22:58:47'),
(2, 8, 20, 1, '2022-10-15 22:59:44', '2022-10-15 22:59:44'),
(3, 9, 20, 1, '2022-10-15 23:00:17', '2022-10-15 23:00:17'),
(4, 10, 17, 1, '2022-10-15 23:00:58', '2022-10-15 23:00:58'),
(5, 11, 18, 1, '2022-10-16 20:13:42', '2022-10-16 20:13:42'),
(6, 16, 17, 1, '2022-10-21 18:31:36', '2022-10-21 18:31:36'),
(7, 17, 19, 1, '2022-10-21 18:33:39', '2022-10-21 18:33:39'),
(8, 18, 19, 2, '2022-10-24 17:09:21', '2022-10-24 17:09:21');
...
INSERT INTO `users` (`id`, `nama_lengkap`, `username`, `email`, `password`, `no_telp`, `provinsi_id`, `kabupaten_id`, `kode_pos`, `alamat_lengkap`, `level_user`, `created_at`, `updated_at`) VALUES
(1, 'Admin', 'admin', 'admin@gmail.com', '$2y$10$N2IqIdx9SRfcCoV82ZZC6uL/Fvjnxm8iQpLAf4fTFqsGbWB.Z.yja', NULL, NULL, NULL, NULL, NULL, 'Admin', NULL, NULL),
(2, 'Pengguna', 'pengguna', 'pengguna@gmail.com', '$2y$10$KZ8l/cr/9ZGhuN5ObS0/COd5jIGQ5411/BeC7S9Ugm0/xDggVrtH6', '089691595169', 35, 3576, '61354', 'Kota Mojokerto, Pulorejo', 'Pengguna', NULL, NULL);
...
ALTER TABLE `transaksi`
  ...
  ADD KEY `transaksi_provinsi_id_foreign` (`provinsi_id`),
  ADD KEY `transaksi_kabupaten_id_foreign` (`kabupaten_id`);
...
--
ALTER TABLE `kategori_produk`
  MODIFY `id_kategori_produk` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT untuk tabel `keranjang`
--
ALTER TABLE `keranjang`
  MODIFY `id_keranjang` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `produk`
  MODIFY `id_produk` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
...
--
ALTER TABLE `transaksi_detail`
  MODIFY `id_transaksi_detail` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `transaksi`
  ADD CONSTRAINT `transaksi_kabupaten_id_foreign` FOREIGN KEY (`kabupaten_id`) REFERENCES `kabupaten` (`id_kabupaten`),
  ADD CONSTRAINT `transaksi_provinsi_id_foreign` FOREIGN KEY (`provinsi_id`) REFERENCES `provinsi` (`id_provinsi`),
